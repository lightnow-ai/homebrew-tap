class LightnowCli < Formula
  include Language::Python::Virtualenv

  desc "Command-line interface for LightNow MCP configuration"
  homepage "https://github.com/lightnow-ai/lightnow-cli"
  url "https://files.pythonhosted.org/packages/dd/ba/7af664c16b66fdcdd5ffdefe51536cbcbc8eafdc2f50463e89905ddbb0b4/lightnow_cli-1.0.3.tar.gz"
  sha256 "241645b2b6810c83c3c6543a7300b6f9c1d31d564f82f211d7de9d89cca8951b"
  license "Apache-2.0"
  ...
  test do
    assert_match "LightNow CLI 1.0.3", shell_output("#{bin}/lightnow --version")
  end
end
